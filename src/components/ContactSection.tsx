          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="w-full h-64 bg-background/10 rounded-2xl border-2 border-background/20 flex items-center justify-center">
                <span className="text-background/60 text-sm">Doctor 1</span>
              </div>
              <div className="w-full h-64 bg-background/10 rounded-2xl border-2 border-background/20 flex items-center justify-center">
                <span className="text-background/60 text-sm">Doctor 2</span>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="opacity-90">XXXXXXXXXXXXXX</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="opacity-90">(xx) xxxx-xxxx</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="opacity-90">xxxxxxxxxxxx</p>
                </div>
              </div>
            </div>
            
            <Button variant="hero" size="lg" className="bg-medical-orange hover:bg-medical-orange-hover">
              Agendar Consulta
            </Button>
          </div>
        </div>
